...
_scope1 = "rhsusf_acc_ACOG2";	// Holosight
_scope2 = "optic_MRCO";			// MRCO Scope - 1x - 6x
_scope3 = "optic_SOS";			// SOS Scope - 18x - 75x
_scope4 = "rhsusf_acc_ELCAN"; // MG scope
_scope5 = "tf47_optic_m3maaws"; 	// Ye man maaws sight
...
_glsmokered = "rhs_mag_m716_yellow";
...
// Backpacks
_bagsmall = "MNP_B_ACU_AP";			// carries 120, weighs 20
_bagmedium = "MNP_B_ACU_KB";				// carries 240, weighs 30
_baglarge =  "MNP_B_ACU_KB"; 			// carries 320, weighs 40
...
_baseUniform = ["MNP_CombatUniform_Ranger_C","MNP_CombatUniform_Ranger_E"];
_baseHelmet = ["MNP_Helmet_ACU"];
_baseGlasses = [];

// Armored vests
_lightRig = ["MNP_Vest_ACU_1","MNP_Vest_ACU_2"];
_mediumRig = ["MNP_Vest_ACU_1","MNP_Vest_ACU_2"]; 	// default for all infantry classes
_heavyRig = ["MNP_Vest_ACU_1","MNP_Vest_ACU_2"];
...
// Crewman
_crewUniform = ["MNP_CombatUniform_Ranger_B","MNP_CombatUniform_Ranger_A"];
_crewHelmet = ["MNP_Boonie_ACU"];
_crewRig = ["MNP_Vest_ACU_1"];
_crewGlasses = [];
