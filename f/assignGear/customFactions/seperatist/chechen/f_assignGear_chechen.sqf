// F3 - Folk Assign Gear Script - Chechen
...
_scope1 = "hlc_optic_kobra";	// Kobra sight for HLC AKs
_scope2 = "optic_MRCO";			// MRCO Scope - 1x - 6x
_scope3 = "rhs_acc_pso1m2";		// RHS PSO Scope, only works on RHS SVDs
...
// Hand Flares
_flare = "AGM_HandFlare_White";
_flaregreen = "AGM_HandFlare_Green";
_flarered = "AGM_HandFlare_Red";
...
_democharge = "SatchelCharge_Remote_Mag";
_APmine1 = "APERSBoundingMine_Range_Mag";
_APmine2 = "APERSMine_Range_Mag";
_Detonator = "AGM_M26_Clacker";
_DefuseKit = "AGM_DefusalKit";
...
_baseUniform = ["U_BG_Guerrilla_6_1","U_BG_Guerilla2_3","U_BG_Guerilla2_2"];
_baseHelmet = ["H_Booniehat_oli","H_Cap_oli","H_Shemag_olive"];
_baseGlasses = ["G_Balaclava_oli","G_Bandanna_aviator","G_Bandanna_oli","G_Aviator"];

// Armored vests
_lightRig = ["rhs_vydra_3m","V_Chestrig_oli"];
_mediumRig = ["V_TacVest_blk","V_TacVest_brn","V_TacVest_camo","V_TacVest_oli"]; 	// default for all infantry classes
...
_crewGlasses = ["G_Aviator","G_Bandanna_aviator","G_Bandanna_oli"];

// Ghillie
_ghillieUniform = ["U_BG_Guerilla3_1"];
_ghillieHelmet = ["H_Cap_headphones"];
_ghillieRig = ["V_HarnessOSpec_brn"];
_ghillieGlasses = ["rhs_scarf"];
...
_backpack = {
	...
	{
		#include "f_assignGear_chechen_b.sqf";
	};
};
...
// LOADOUT: AUTOMATIC RIFLEMAN
	case "ar":
	{
		...
		_unit addmagazines [_ARmag_tr,4];
		_unit addweapon _AR;
		_unit addmagazines [_grenade,1];
		_unit addmagazines [_mgrenade,1];
		_unit addmagazines [_smokegrenade,2];
